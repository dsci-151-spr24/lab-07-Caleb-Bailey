...
2.  How many observations are in this dataset?
  ...
  ***There are `r nrow(Whickham)` observations in this dataset. Each observation represents one particular woman in this study.***
...
***This does not meet what I thought would happen. It appears that those who smoked have a higher probability of being alive 20 years later.*** 
...
```
***In the plot it appears that smokers have a higher probabiltity of being dead in each age category.***
```{r}
Whickham %>%
